...
os.path.abspath()===>/home/python/Desktop/meiduo_tbd39/meiduo/meiduo/settings/dev.py
os.path.dirname()===>/home/python/Desktop/meiduo_tbd39/meiduo/meiduo/settings
os.path.dirname()===>/home/python/Desktop/meiduo_tbd39/meiduo/meiduo
'''
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.jinja2.Jinja2', # 使用jinja2模版
...
# 指定文件存储类型
DEFAULT_FILE_STORAGE = 'meiduo.utils.fdfs.storage.FdfsStorage'
